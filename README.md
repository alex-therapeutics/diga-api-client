...
## Project Status
The first version of the project has been released. Currently, the DiGA code validation works against 97/104 health insurance companies and invoicing works against 98/104 companies. However, there are still issues with a few endpoints. You can track this further [here](ENDPOINT_STATUS.md) and there is also an issue for each non-working endpoint.
